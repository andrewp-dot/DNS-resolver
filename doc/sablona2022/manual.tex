...
\projectinfo{
  %Prace / Thesis
  % project={ISA},            %typ práce BP/SP/DP/DR  / thesis type (SP = term project)
  year={2023},             % rok odevzdání / year of submission
  date=\today,             % datum odevzdání / submission date
  %Nazev prace / thesis title
  title.cs={DNS resolver},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  ...
  author.surname={Ponechal},   % příjmení autora / author surname 
...
\ifslovak
  \makeatletter
  \def\@openbib@code{\addcontentsline{toc}{chapter}{\protect\numberline{\arabic{chapterCounter}}Literatúra}}
  \makeatother
